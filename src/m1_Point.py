...
class Point(object):
    ...
    def get_number_f_moves_made(p1, x, y):
        p1.get_number_of_moves_made = 0
        if p1.move_by(p1):
            p1.get_number_of_moves_made = p1.get_number_of_moves_made + 1
        return p1.get_number_of_moves_made
